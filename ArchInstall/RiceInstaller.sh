...
dependencias=(alacritty base-devel bat brightnessctl bspwm dunst eza feh gvfs-mtp firefox geany git kitty imagemagick jq \
			        ...
			        redshift rofi rustup sxhkd tmux ttf-inconsolata ttf-mononoki-nerd ttf-jetbrains-mono ttf-jetbrains-mono-nerd \
			        ...
			        xorg-xwininfo fish fisher fzf cmus starship yazi)
